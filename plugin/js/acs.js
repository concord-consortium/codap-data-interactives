...
let acs = {
    ...
    getAllAttributes: async function () {
        // acs.decoder = await acs.DBconnect.getDBInfo("getDecoderInfo");
        // acs.ancestries = await acs.DBconnect.getDBInfo("getAncestries");
    ...
    attributeAssignment: [
      {ipumsName: 'AGE', title: 'age', group: 1},
      {ipumsName: 'SEX', title: 'sex', group: 1},
      {ipumsName: 'MARST', title: 'marital status', group: 1},
      {ipumsName: 'NCHILD', title: 'own children', group: 1},
      {ipumsName: 'FERTYR', title: 'children in past year', group: 1},
      {ipumsName: 'EDUC', title: 'education', group: 1},
      {ipumsName: 'RACE', title: 'race', group: 2},
      {ipumsName: 'RACESING', title: 'singular race', group: 2},
      {ipumsName: 'HISPAN', title: 'hispanic', group: 2},
      {ipumsName: 'CITIZEN', title: 'citizenship', group: 2},
      {ipumsName: 'YRIMMIG', title: 'year of immigration', group: 2},
      {ipumsName: 'BPL', title: 'birthplace', group: 2},
      {ipumsName: 'SPEAKENG', title: 'speak English', group: 2},
      {ipumsName: 'EMPSTAT', title: 'employment', group: 3},
      {ipumsName: 'LABFORCE', title: 'labor force', group: 3},
      {ipumsName: 'CLASSWKR', title: 'worker class', group: 3},
      {ipumsName: 'UHRSWORK', title: 'working hours', group: 3},
      {ipumsName: 'WKSWORK2', title: 'working weeks', group: 3},
      {ipumsName: 'WORKEDYR', title: 'worked in year', group: 3},
      {ipumsName: 'OCC1950', title: 'occupation 1950', group: 3},
      {ipumsName: 'OCC2000', title: 'occupation 2000', group: 3},
      {ipumsName: 'IND1950', title: 'industry 1950', group: 3},
      {ipumsName: 'IND2000', title: 'industry 2000', group: 3},
      {ipumsName: 'INCTOT', title: 'income', group: 4},
      {ipumsName: 'INCWAGE', title: 'wage income', group: 4},
      {ipumsName: 'FTOTINC', title: 'family income', group: 4},
      {ipumsName: 'INCEARN', title: 'earned income', group: 4},
      {ipumsName: 'CPI99', title: 'adjusted income', group: 4},
      {ipumsName: 'INCWELFR', title: 'welfare income', group: 4},
      {ipumsName: 'POVERTY', title: 'percent of poverty', group: 4},
      {ipumsName: 'REGION', title: 'region', group: 5},
      {ipumsName: 'STATEFIP', title: 'state', group: 5},
      {ipumsName: 'MIGRATE1', title: 'moved', group: 5},
      {ipumsName: 'PERWT', title: 'person weight', group: 6},
      {ipumsName: 'SLWT', title: 'sample line weight', group: 6},
      {ipumsName: 'SELFWTSL', title: 'self weight', group: 6},
      {ipumsName: 'YEAR', title: 'year', group: 6}
    ]
