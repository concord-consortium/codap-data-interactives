      ...
      */
      ...
      handleAttributeChange = function () {
        ...
        codapInterface.sendRequest({
          ...
          if (maxAttrsFound = 1) {
            ...
            if (attributeName === 'Height' && attributeAxis === 'horizontal') this.handleAccomplishment('AddHeight');else if (attributeName === 'Remove Y: Gender' && attributeAxis === 'vertical') this.handleAccomplishment('AddRemoveGenderVertical');
          };
        }.bind(this));
      }.bind(this),
        ...
        if (iNotification.values.type === 'DG.GraphModel' && iNotification.values.attributeName === 'Height') this.handleAccomplishment('MakeLegend');
      }.bind(this),
        ...
        if (iNotification.values.type === 'DG.TableView' && iNotification.values.operation === 'toggle minimize component') console.log("Minimize: ", this.isAccomplished('MinimizeTable'));
        console.log("Expand: ", this.isAccomplished('ExpandTable'));
        if (this.isAccomplished('MinimizeTable')) this.handleAccomplishment('ExpandTable');else this.handleAccomplishment('MinimizeTable');
      }.bind(this),
      ...
      switch (iNotification.values.operation) {
        ...
        case 'create':
          ...
          if (iNotification.values.type === 'graph') this.handleAccomplishment('MakeGraph');else if (iNotification.values.type === 'caseTable') this.handleAccomplishment('CreateTable');
          break;
        case 'move':
