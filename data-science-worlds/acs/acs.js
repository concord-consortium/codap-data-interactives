...
let acs = {
    ...
    attributeGroups : [
        {number : 1, open : false, title : "Basic interesting stuff"},
        {number : 5, open : false, title : "Race, ancestry, language, origin"},
        {number : 6, open : false, title : "Work and employment"},
        {number : 2, open : false, title : "Income"},
        {number : 7, open : false, title : "Health"},
        {number : 8, open : false, title : "Difficulty and disability"},
        {number : 3, open : false, title : "Catchall"},
        {number : 0, open : false, title : "Database info"}
    ],
