...
// }
//
// function endCODAPDoc(doc) {
//   delete doc.index;
// }
//
// function addContext(doc, name) {
//   var contextDef = {
//     guid: ++doc.index,
//     name: name,
//     type: "DG.DataContext",
//     collections: []
//   };
//   doc.contexts.push(contextDef);
//   return contextDef;
// }
//
// function addCollection(doc, context, name, parentCollection) {
//   var collectionDef =  {
//     guid: ++doc.index,
//     name: name,
//     attrs: [],
...
//   };
//   if (parentCollection) {
//     collectionDef.parent = parentCollection.guid;
//   }
//   if (context) {
//     context.collections.push(collectionDef);
//   }
//   return collectionDef;
// }
//
// function addAttribute(doc, collection, name, properties) {
//   var attrDef = Object.assign({
//     guid: ++doc.index,
//     name: name
//   }, properties);
//   collection.attrs.push(attrDef);
//   return attrDef;
// }
//
// function addCase(doc, collection, values, parentCase) {
//   var myCase = {
//     guid: ++doc.index,
//     values: values
//   };
//   if (parentCase) {
//     myCase.parent = parentCase.guid;
//   }
//   collection.cases.push(myCase);
//   return myCase;
// }
//
...
// }
//
// function addTableComponent (doc, title, dataContext) {
//   var component = {
//     guid: ++doc.index,
//     type: 'DG.TableView',
//     title: title,
//     componentStorage: {
//       _links_: {
//         context: makeLink('DG.DataContextRecord', dataContext)
//       }
//     }
//   };
...
//   return component;
// }
// function addMapComponent(doc, title) {
//   var component = {
//     guid: ++doc.index,
//     type: 'DG.MapView',
//     componentStorage: {
...
// }
//
// function addTextComponent(doc, title, message) {
//   var component = {
//     guid: ++doc.index,
//     type: 'DG.TextView',
//     componentStorage: {
...
//     });
//   }
//   var doc = beginCODAPDoc();
//   var context, parentCollection, childCollection;
//   try {
//
//     var geoJSONObject = (typeof geojsonDoc === 'string')?
...
//       if (isKey(geoJSONObject, property)) {
//         featureKeys.push(property);
//       }
//     });
//
//     // create data context structure
//     context = addContext(doc, 'data');
//     parentCollection = addCollection(doc, context, 'boundaries');
//     Object.keys(featureProperties).forEach(function (propertyName) {
//       addAttribute(doc, parentCollection, propertyName);
//     });
//     if (hasShapeData) {
//       addAttribute(doc, parentCollection, 'boundary', {type: 'boundary'});
//     }
//     if (hasPointData) {
//       addAttribute(doc, parentCollection, 'latitude');
//       addAttribute(doc, parentCollection, 'longitude');
//     }
//     childCollection = addCollection(doc, context, 'keys', parentCollection);
//     addAttribute(doc, childCollection, 'type');
//     addAttribute(doc, childCollection, 'key');
//
//     // create cases
//     geoJSONObject.features.forEach(function (feature) {
//       var type = feature.geometry && feature.geometry.type;
//       var point, parentCase;
//       if (type === 'Point') {
//         point = feature.geometry.coordinates;
//         parentCase = addCase(doc, parentCollection, Object.assign({latitude: point[1], longitude: point[0]}, feature.properties));
//       } else {
//         // create parent case
//         parentCase = addCase(doc, parentCollection,
//             Object.assign({boundary: JSON.stringify(
//                   injectThumbnailInGeojsonFeature(feature.geometry))},
//                 feature.properties));
//       }
//       // add child cases
//       featureKeys.forEach(function (key) {
//         addCase(doc, childCollection, {type: key, key: feature.properties[key]}, parentCase);
//       });
//       if (feature.id) {
//         addCase(doc, childCollection, {type: 'id', key: feature.id});
//       }
//     });
//
//     // create table component
//     addTableComponent(doc, 'boundaries', context);
//
//     // create text component
//     addTextComponent(doc, 'Original File', url);
//
//     // create map component
//     addMapComponent(doc, 'map');
//
//     endCODAPDoc(doc);
//   }
//   catch(ex) {
//     console.log('Error importing "' + url + '": ' + ex);
//   }
//   return doc;
// }
