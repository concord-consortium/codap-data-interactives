...
var noaaCDOConnect = {
    ...
    doGetHandler: async function (ev) {
        ...
        let tURL = noaaCDOConnect.constants.noaaBaseURL + "data?limit=" + noaaCDOConnect.constants.recordCountLimit + tDatasetIDClause + tStationIDClause + tDataTypeIDClause + tDateClause;
                ...
                if (tResult.ok) {
                    ...
                    if (theJSON.results) {
                        ...
                        theJSON.results.forEach((r) => {
                            ...
                            noaaCDOConnect.dataValues.push(aValue);
                        });
                        noaaCDOConnect.dataRecords = [];
                        noaaCDOConnect.dataValues.forEach(function (aValue) {
                            let dataRecord = noaaCDOConnect.dataRecords.find(
                                function (r) {
                            ...
                            if (!dataRecord) {
                                ...
                                noaaCDOConnect.dataRecords.push(dataRecord);
                            }
                        ...
                        await codapConnect.createNOAAItems(noaaCDOConnect.constants,
                            noaaCDOConnect.dataRecords, noaaCDOConnect.getSelectedDataTypes());
                        resultText = "Retrieved " + noaaCDOConnect.dataRecords.length + " cases";
                    } else {
