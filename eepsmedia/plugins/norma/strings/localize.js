...
const localize = {
    ...
    fileNameMap : {
        en : "strings/norma_English.json",
        es : "strings/norma_Spanish.json",
        de : "strings/norma_German.json",
        fr : "strings/norma_French.json",
        it : "strings/norma_Italian.json",
    },
    ...
    getString : function(iID, ...theArgs) {
        const theRawString = eval(`DG.plugins.norma.${iID}`);
        let out = "";
        if (theRawString) {
            out = replaceSubstrings(theRawString, ...theArgs);
        } else {
            const theDefaultString = eval(`this.defaultStrings.norma.${iID}`);
            if (theDefaultString) {
    ...
    setStaticStrings: async function () {
        ...
        const theStaticStrings = DG.plugins.norma.staticStrings;
